...
<!-- _class: lead -->
![bg right:48% cover](./slide-images/hero-workspace.svg)

# Codex App Hands-on

今日は、Codex Appを<span class="accent">開発ワークスペース</span>として使います。
...
![w:1120](./slide-images/workflow-map.svg)
...
- 長めの実装を任せやすい
- ターミナル、ファイル編集、ブラウザ確認、Git差分が同じ画面にある
- MCPやAutomationsも、別々の道具をつなぎ込む前から試せる

今日は、この「開発の流れが1か所で進む」感じを見てください。
...
実装した画面を、そのままCodex Appのin-app browserで見ます。

ここでレイアウト、文字の重なり、ボタンの押しやすさを確認します。

![bg right:42% contain](./slide-images/dashboard.jpg)
...
![bg right:46% contain](./slide-images/computer-use-live.svg)
